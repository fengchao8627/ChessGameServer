...
import info.xiaomo.server.system.scene.Point;
import info.xiaomo.server.system.scene.constant.MapConst.Dir;
...
public class GeomUtil {
    ...
    public static Point nextDirPoint(Point point, Dir dir) {
        ...
        Point[] nears = point.getNears();
        Point ret = nears[dir.getIndex()];
        if (ret == null) {
            return null;
        }
    ...
    public static Point nextDirPoint(Point point, int dirIndex) {
